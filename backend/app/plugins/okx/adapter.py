...
class AdapterImpl(Adapter):
    ...
    def health_check(self, credentials: dict[str, Any], options: dict[str, Any]) -> HealthStatus:
        return HealthStatus(ok=False, message="TODO: Implement OKX health check")
    ...
    def fetch_fills(
        ...
        raise NotImplementedError("TODO: Implement OKX fetch_fills")
    ...
    def fetch_cashflows(
        ...
        raise NotImplementedError("TODO: Implement OKX fetch_cashflows")
