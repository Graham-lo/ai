...
class AdapterImpl(Adapter):
    ...
    def health_check(self, credentials: dict[str, Any], options: dict[str, Any]) -> HealthStatus:
        return HealthStatus(ok=False, message="TODO: Implement Binance health check")
    ...
    def fetch_fills(
        ...
        raise NotImplementedError("TODO: Implement Binance fetch_fills")
    ...
    def fetch_cashflows(
        ...
        raise NotImplementedError("TODO: Implement Binance fetch_cashflows")
